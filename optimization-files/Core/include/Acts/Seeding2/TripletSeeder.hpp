...
class TripletSeeder {
 public:
  ...
  struct Cache {
    ...
    /// Sorted container of bottom doublet indices
    std::vector<DoubletsForMiddleSp::Index> sortedBottoms;
    /// Sorted container of top doublet indices
    std::vector<DoubletsForMiddleSp::Index> sortedTops;

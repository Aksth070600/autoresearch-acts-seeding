...
ProcessCode GridTripletSeedingAlgorithm::execute(
  ...
  boost::container::small_vector<Acts::SpacePointContainer2::ConstRange, 27> bottomSpRanges;
  std::optional<Acts::SpacePointContainer2::ConstRange> middleSpRange;
  boost::container::small_vector<Acts::SpacePointContainer2::ConstRange, 27> topSpRanges;

...
ProcessCode GridTripletSeedingAlgorithm::execute(
  ...
  static thread_local Acts::SeedContainer2::Index seedCapacityHint = 0;
  Acts::SeedContainer2 seeds;
  seeds.reserve(seedCapacityHint);
  ...
  if (seeds.size() > seedCapacityHint) {
    seedCapacityHint = seeds.size();
  }

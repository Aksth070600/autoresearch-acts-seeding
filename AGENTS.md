...
- For owned-static v4 production, candidate identity, calibration, records, and exact protocol isolation, follow `orchestration-files/acts-v4-static/README.md`; keep its consumers separate from v3. Continuous v4 science uses `acts-v4-continuous-campaign/status.json`; the canonical campaign snapshot is authentication bridge data only.

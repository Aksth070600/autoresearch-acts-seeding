...
- 2026-08-26 | candidate: ResizeSortedCandidateOutput | outcome: discard | lesson: Resizing sorted candidate output before indexed copies passed all stages but slowed timed total to 2582.12 ms/event; retain clear, reserve, and emplace_back.
- 2026-08-26 | candidate: CacheTripletFilterScalarsOnMapParent | outcome: discard | lesson: Caching three triplet filter scalar constants from the map parent passed all stages but slowed timed total to 2576.25 ms/event; retain direct configuration access.
- 2026-08-26 | candidate: DirectSortCandidateHeaps | outcome: discard | lesson: Replacing sort_heap with direct ranges::sort passed all stages but slowed timed total to 2587.20 ms/event; retain heap sorting.
- 2026-08-26 | candidate: CacheZRReferencesOnMapParent | outcome: discard | lesson: Caching bottom and middle ZR references from the map parent passed all stages but slowed timed total to 2535.53 ms/event and reduced ambiguity track efficiency to 0.574888; retain proxy access.
- 2026-08-26 | candidate: CacheTripletCandidateViewsOnMapParent | outcome: discard | lesson: Caching triplet candidate vector views from the map parent passed all stages but slowed timed total to 2575.71 ms/event; retain direct container accessors.
